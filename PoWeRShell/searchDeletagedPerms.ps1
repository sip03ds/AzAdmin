...
$bSearch = New-Object System.DirectoryServices.DirectoryEntry("LDAP://DC3STLMRS.CORP.VIONET.GR/LDAP","VIONET\t0_distathopoulos","&UJM6yhn%TGB4rfv#EDC2wsx") #connect to DOMAINCONTROLLER using LDAP path
